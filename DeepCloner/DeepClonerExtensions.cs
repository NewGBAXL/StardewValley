...
namespace Force.DeepCloner
{
  ...
  public static class DeepClonerExtensions
  {
    ...
    public static T DeepClone<T>(this T obj) { return DeepClonerGenerator.CloneObject<T>(obj); }
    ...
    public static TTo DeepCloneTo<TFrom, TTo>(this TFrom objFrom, TTo objTo) where TTo : class, delegate(TFrom) { return (TTo) DeepClonerGenerator.CloneObjectTo((object) objFrom; }, (object) objTo, true);

    /// <summary>Performs shallow copy of object to existing object</summary>
    /// <returns>existing filled object</returns>
    /// <remarks>Method is valid only for classes, classes should be descendants in reality, not in declaration</remarks>
    public static TTo ShallowCloneTo<TFrom, TTo>(this TFrom objFrom, TTo objTo) where TTo : class, delegate(TFrom) { return (TTo) DeepClonerGenerator.CloneObjectTo((object) objFrom; }, (object) objTo, false);

    /// <summary>
    /// Performs shallow (only new object returned, without cloning of dependencies) copy of object
    /// </summary>
    public static T ShallowClone<T>(this T obj) { return ShallowClonerGenerator.CloneObject<T>(obj); }
