...
namespace StardewValley.Monsters
{
  public class GreenSlime : Monster
  {
    ...
    public override List<Item> getExtraDropItems()
    {
      ...
      if (!this.prismatic.Value || Game1.player.team.specialOrders.Where<SpecialOrder>((Func<SpecialOrder, bool>) (x { return (string) (NetFieldBase<string; }, NetString>) x.questKey == "Wizard2")) == null)
